...
test('the built package contains runnable exports without monorepo files', async () => {
  ...
  expect(packed.files.map(({ path }: { path: string }) => path).sort()).toEqual([
    ...
    'dist/parts/PrepareFrame/PrepareFrame.d.ts',
    'dist/parts/PrepareFrame/PrepareFrame.js',
    ...
    'dist/parts/TimelinePreview/TimelinePreview.d.ts',
    'dist/parts/TimelinePreview/TimelinePreview.js',
    'dist/parts/Transfer/Transfer.d.ts',
    'dist/parts/Transfer/Transfer.js',
    'dist/parts/Types/Types.d.ts',
    'dist/parts/Types/Types.js',
    'dist/parts/ViewEvent/ViewEvent.d.ts',
    'dist/parts/ViewEvent/ViewEvent.js',
    'dist/parts/ViewRender/ViewRender.d.ts',
    'dist/parts/ViewRender/ViewRender.js',
    'dist/player.js',
